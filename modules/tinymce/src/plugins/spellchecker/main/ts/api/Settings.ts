...
const getSpellcheckerWordcharPattern = (editor: Editor) => {
  ...
  '\u00bc\u00bd\u00be\u00bf\u00d7\u00f7\u00a4\u201d\u201c\u201e\u00a0\u2002\u2003\u2009' +
  ']+';
  return new RegExp(editor.getParam('spellchecker_wordchar_pattern', defaultPattern), 'g');
};

const getSpellcheckerWordValidator = (editor: Editor) => {
  return editor.getParam('spellchecker_word_validator');
};
